...
(()=>{var e=class{constructor(){}create(){let o=document.createElement("div"),t=document.createElement("div");o.id="bm-overlay",t.id="bm-panbar",o.appendChild(t),document.body.appendChild(o)}};var a=GM_getResourceText("CSS-Overlay");GM_addStyle(a);console.log("Blue Marble script has loaded.");var r=new e;r.create();})();
